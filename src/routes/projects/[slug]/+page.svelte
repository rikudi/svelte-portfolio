<script>
  ...
  <div class="flex flex-col gap-12 lg:gap-20">
    ...
    <div class="flex flex-col items-center gap-10 lg:flex-row">
      <img src={`../${data.thumb}`} alt={`${data.title} by ${data.resume.title}`} width="250" height="250" class="rounded-2xl" style={`view-transition-name: img-${convertToSlug(data.title)}`} />
    ...
    <div class="text-xl leading-snug md:text-3xl lg:text-3xl lg:font-extralight lg:leading-tight [&_a]:border-b [&_a]:border-b-black">
