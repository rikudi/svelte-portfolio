...
<div class="text-gray-700"> 
  {#if resume}
  <h1 class="text-5xl pb-2 flex gap-2"><strong>{resume.first_name}</strong><p class="font-thin">{resume.last_name}</p></h1>
  <p class="text-primary">{resume.tagline}</p>
  {/if}
</div>